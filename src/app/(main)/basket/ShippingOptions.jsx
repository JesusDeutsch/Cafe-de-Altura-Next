...
const ShippingOptions = () => {
  const { shippingOption, updateShippingOption, getShippingCost } =
  ...
  return (
    <div className="flex flex-col gap-4">
      <h3 className="font-semibold w-[143px] h-[24px] leading-6 text-black">
        Seleccionar envío
      </h3>
      ...
      <form className="flex flex-col justifc">
        <div className="flex items-center w-[776px] h-9 gap-4 mb-4">
          ...
          <label
            htmlFor="standard"
            className="w-[657px] h-9 gap-2 cursor-pointer"
          >
            <div className="font-semibold text-[14px] h-4 leading-4">
              Envío 5-7 días
            </div>
            <div className="font-normal w-[202px] h-4 text-[14px] leading-4">
