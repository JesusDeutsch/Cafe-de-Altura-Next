...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center fixed px-3 py-10 w-full bg-[#2b2a2b] text-[#FFFFFF] h-16">
        <Link href="/">
      <div className="flex gap-[7.33px] w-[214px] h-[36px]">
          <p className="flex items-center w-[186px] h-[36px] opacity-[86%] text-[24px] leading-[35px] font-normal gap-2">
            {"cafedealtura.com "}
          </p>
          <span className="flex items-center">
            <Image src="/home-page/navbar/ps_coffee-hot.png" alt="coffee" width={20.53} height={24.93} />
      ...
      <li className={`flex justify-center items-center w-[61px] h-8 px-2 rounded-[10px] cursor-pointer text-[14px] ${['/shop'].some(path => pathname.includes(path))  
            ? 'bg-[#515051] text-white' 
            : 'hover:bg-[#f7f5f31a]'
        }`}>
          <Link href="/shop">Tienda</Link>
        </li>
        <li className={`flex justify-center items-center h-8 px-2 rounded-[10px] cursor-pointer w-[89px]  text-[14px] ${
        ...
        <li className={`flex justify-center items-center h-8 px-2 rounded-[10px] cursor-pointer w-[111px]  text-[14px] ${
          pathname === '/companies' 
            ? 'bg-[#515051] text-white' 
            : 'hover:bg-[#f7f5f31a]'
        }`}>
        ...
        <li className={`flex justify-center items-center h-8 px-2 rounded-[10px] cursor-pointer w-[112px]  text-[14px] ${
          pathname === '/about-us' 
            ? 'bg-[#515051] text-white' 
            : 'hover:bg-[#f7f5f31a]'
        }`}>
        ...
        <li className={`flex justify-center items-center h-8 px-2 rounded-[10px] cursor-pointer w-[75px]  text-[14px] ${
          pathname === '/contact' 
            ? 'bg-[#515051] text-white' 
            : 'hover:bg-[#f7f5f31a]'
        }`}>
